...
?>
<aside class="sidebar-custom <?= $paginaActual === 'producto' ? 'active disabled' : '' ?>" id="sidebar">
    ...
    <div class="menu-container">
        ...
        <ul class="nav nav-pills flex-column mb-4" style="font-size: 18px;">
            ...
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/producto"
                    class="nav-link-custom  <?= $paginaActual === 'producto' ? 'active disabled' : '' ?>"
            ...
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/categoria"
                    class="nav-link-custom <?= $paginaActual === 'categoria' ? 'active disabled' : '' ?>"
                    data-tooltip="Categorias">📁
                    <span class="texto-modulo">Categorías</span></a>
            </li>
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/proveedor"
                    class="nav-link-custom <?= $paginaActual === 'proveedor' ? 'active disabled' : '' ?> "
                    data-tooltip="Proveedores">🚚
                    <span class="texto-modulo">Proveedores</span></a>
            </li>
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/compra"
                    class="nav-link-custom <?= $paginaActual === 'compra' ? 'active disabled' : '' ?> "
                    data-tooltip="Compras">🛒 <span class="texto-modulo">Compras</span></a>
            </li>
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/venta"
                    class="nav-link-custom <?= $paginaActual === 'venta' ? 'active disabled' : '' ?> "
                    data-tooltip="Ventas">💰 <span class="texto-modulo">Ventas</span></a>
            </li>
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/usuario"
                    class="nav-link-custom <?= $paginaActual === 'usuario' ? 'active disabled' : '' ?> "
                    data-tooltip="Usuarios">👤 <span class="texto-modulo">Usuarios</span></a>
            </li>
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/ia"
                    class="nav-link-custom <?= $paginaActual === 'ia' ? 'active disabled' : '' ?>"
                    data-tooltip="Asesor Virtual">🤖
                    <span class="texto-modulo">Asesor Virtual</span></a>
            </li>
    ...
    <div class="sidebar-footer mt-auto pt-3 border-top dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownPerfil">
            ...
            <li class="nav-item">
                <a href="<?= URL_BASE ?>/perfil/apariencia"
                    class="nav-link-custom <?= $paginaActual === 'apariencia' ? 'active disabled' : '' ?> "
                    data-tooltip="Apariencia"> <i class="bi bi-gear me-2"></i> <span
                        class="texto-modulo">Apariencia</span></a>
            </li>

            <hr class="my-1 mx-2 border-secondary">

            <li class="nav-item">
                <a href="<?= URL_BASE ?>/login/logout"
                    class="nav-link-custom <?= $paginaActual === 'logout' ? 'active disabled' : '' ?>  text-danger"
